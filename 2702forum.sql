...
INSERT INTO `topic` (`id_topic`, `title`, `creationdate`, `closed`, `user_id`, `category_id`) VALUES
	...
	(7, 'Marine Life', '2022-02-21 18:56:33', 1, 1, 2),
...
INSERT INTO `user` (`id_user`, `username`, `password`, `role`, `banned`) VALUES
	(1, 'ethan_carter', 'ethan_carter123', '["ROLE_USER"]', 0),
	(2, 'sophie_li', 'sophie_li123', '["ROLE_USER"]', 0),
	(3, 'noah_martinez', 'noah_martinez123', '["ROLE_USER"]', 0),
	(4, 'lily_anderson', 'lily_anderson123', '["ROLE_USER"]', 1),
	(5, 'Alex', '$2y$10$FUMK2vb8QnOo3lX8IbaEo.jU4muWZfgj2KITeL/x9V5ZA0I6jaIu2', '["ROLE_USER"]', 1),
	(6, 'Pauline', '$2y$10$gFXw4yDR.BoDXmAnWwIxcuxLZT4KqucLst5Qm.sDxk6XVW4n03lBK', '["ROLE_ADMIN"]', 0),
	(7, 'Camille', '$2y$10$ysSAYvQDmdUqiExioivhKehWTsRnBnn5RIh0FQ4JSfv6gR9H686hO', '["ROLE_USER"]', 1);
